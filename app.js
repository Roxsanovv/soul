...
// ================================================
// ИСПРАВЛЕННАЯ ОТПРАВКА СИГНАЛА ЗВОНКА
// ================================================
...
// ================================================
// ИСПРАВЛЕННЫЙ СЛУШАТЕЛЬ ВХОДЯЩИХ ЗВОНКОВ
// ================================================
...
function resetCallState() {
    console.log("🔄 Сброс состояния звонка");
...
// ================================================
// ИСПРАВЛЕННАЯ ОБРАБОТКА ВХОДЯЩЕГО ЗВОНКА
// ================================================
...
async function acceptCall() {
    try {
        ...
        // Создаем PeerConnection с улучшенной конфигурацией
        const iceServers = {
            iceServers: [
                { urls: 'stun:stun.l.google.com:19302' },
                { urls: 'stun:stun1.l.google.com:19302' },
            ...
            iceCandidatePoolSize: 0, // Убираем пул кандидатов
        ...
        callState.peerConnection.ontrack = (event) => {
            ...
            if (!callState.remoteStream) {
                ...
                if (remoteVideo) {
                    ...
                    remoteVideo.classList.add('active');
                    remoteVideo.muted = false; // Важно: не mute удаленное видео
